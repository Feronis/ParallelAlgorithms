...
/*
 * parallel implementation of sorted array to BST through spark
 * is a lot slower as we process every element a little and spark overhead.
 */
...
public class BSTSpark {
	...
	public static void main(String[] args) {
		...
		//long startTime = System.currentTimeMillis();
		  ...
		  int sizeValue = (int) Math.pow(2,4);
		  ...
		  numRDD.foreach(item -> {
			  ...
			  /*
			   * Here we are assuming the nodevalue will also contain its index in the sorted array
			   * if it doesn't, uncomment the looping structure and remove the int i line
			   * 
			   * To see how this algorithm works, look at the pdf of the assignment solution
			   */
 ...
 /*queryRDD.foreach(item->{
	...
	/*
	 * This traverses the tree, searching for the value.
	 */
